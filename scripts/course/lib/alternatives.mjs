...
export function wordsPrompt({ forms, style }) {
  ...
  const user = [
    ...
    '- when the English meaning is several words for one Spanish word ("from Buenos Aires", "in a hurry"), the short Spanish phrase that says the same thing, with the preposition a learner would naturally add ("de Buenos Aires" for "from Buenos Aires").',
    '',
    'Never list:',
