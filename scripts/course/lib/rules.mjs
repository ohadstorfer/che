...
// and C). Shared by the outline validator, the sentence linter and the
// generator prompt, so the three can never disagree about what is allowed.

/** Registers in increasing order of informality. */
export const REGISTERS = ['neutral', 'informal', 'lunfardo', 'vulgar'];
export const registerRank = (r) => REGISTERS.indexOf(r);

export const POS = [
  'verb', 'noun', 'adj', 'adv', 'pron', 'det', 'prep', 'conj', 'interj', 'num', 'phrase', 'propn',
];
