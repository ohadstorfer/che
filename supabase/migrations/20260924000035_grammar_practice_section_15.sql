...
-- written by scripts/course/grammar-seed.mjs. 2 lessons, 73 pattern tips.

insert into public.lessons (id, unit_id, ordinal, title_en, kind, status) values
  ('47af689d-732b-5189-95db-c797920a6a90', '80d9fccd-c824-5946-8cce-04ecc42e570d', 2000, 'Grammar practice', 'practice', 'published'),
  ('f400df10-c052-5878-90fe-b617ca785212', '35da2974-7119-59d7-bdf3-d14bdf042064', 2001, 'Grammar practice', 'practice', 'published')
...
update public.lessons l set ordinal = v.ordinal from (values
  ...
  ('69685a11-8f4b-5c14-b24d-47273590edd7'::uuid, 1),
  ('3d2be4fa-e0e6-5bf7-adc4-01e9547036bd'::uuid, 2),
  ('efe475ae-147a-5a7c-9d57-74f83c208306'::uuid, 3),
  ('47af689d-732b-5189-95db-c797920a6a90'::uuid, 4),
  ('3c066aae-6bdc-57b0-8ee8-be3ab0c7938c'::uuid, 5),
  ('3fa8afc1-8e55-5ef4-be7b-c1f94050eabe'::uuid, 6),
  ('473d7568-dc37-5126-bc50-da0f2ee95ae0'::uuid, 7),
  ('045ea665-7e87-59e6-a3c9-aff6147bdacf'::uuid, 1),
  ('7fe44219-3377-503d-8c60-52c63f5826f9'::uuid, 2),
  ('0f69a61b-f7cf-59eb-ba97-71ab1b1a467b'::uuid, 3),
  ('2b7be135-6d4d-5911-bb5c-292a3b35fc57'::uuid, 4),
  ('f400df10-c052-5878-90fe-b617ca785212'::uuid, 5),
  ('f41fc52b-332c-5f5c-a15e-319d44f78a19'::uuid, 6),
  ('71528659-62d3-5990-998a-1546e8e0777b'::uuid, 7),
  ('0d97b316-19a8-51ff-8493-8c761ff43fb3'::uuid, 8)
...
**Cuanto más** + one thing, then the other with **más**, **menos**, **mejor**.', 'published'),
  ('5f8b9622-8605-59be-9a2c-df64d8920c28', '80d9fccd-c824-5946-8cce-04ecc42e570d', 'Me lo merezco', '| **Me merezco** un aumento. | I deserve a raise. |
| **Me lo merezco.** | I deserve it. |
| **Te lo merecés.** | You deserve it. |

**Merecerse** comes with its pronoun: the bare *merezco* sounds like a textbook.', 'published'),
  ('28e641b6-4f66-5483-81c2-859687fb0e7f', '35da2974-7119-59d7-bdf3-d14bdf042064', 'Se casó, nació', '| Mi prima **se casó** el sábado. | got married |
| **Nos casamos** en marzo. | we got married |
| El bebé **nació** ayer. | was born |
| ¿Dónde **naciste**? | were you born |

**Casarse** takes its pronoun; **nacer** doesn''t.', 'published')
...
join public.lessons n on n.id in ('47af689d-732b-5189-95db-c797920a6a90', 'f400df10-c052-5878-90fe-b617ca785212')
