...
-- written by scripts/course/grammar-seed.mjs. 3 lessons, 66 pattern tips.

insert into public.lessons (id, unit_id, ordinal, title_en, kind, status) values
  ('4cb309a6-e268-5445-92ac-2bb0b73968e7', 'f46f9df0-afdf-5c8c-95be-a4b002904a9d', 2000, 'Grammar practice', 'practice', 'published'),
  ('e9c90d1e-cefa-531f-8d38-cdde96cd9c85', '7768d3dd-52a9-55e1-be73-c2b2153fdb64', 2001, 'Grammar practice', 'practice', 'published'),
  ('d99a799f-1f9f-5987-a4db-80669f8a018f', 'e5014ed4-167a-55b0-8e66-43bd2ee4e434', 2002, 'Grammar practice', 'practice', 'published')
...
join public.lessons n on n.id in ('4cb309a6-e268-5445-92ac-2bb0b73968e7', 'e9c90d1e-cefa-531f-8d38-cdde96cd9c85', 'd99a799f-1f9f-5987-a4db-80669f8a018f')
